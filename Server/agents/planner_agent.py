...
This agent analyzes user instructions and Subtask Graph to plan
...
class PlannerAgent:
    """Plans optimal subtask paths using Subtask Graph.

    Implements UI Path Planning:
    1. Analyze user instruction to identify goal subtasks
    2. Use BFS on Subtask Graph to find shortest path to goal
    ...
    def _analyze_goal(self, all_subtasks: Dict[int, List[dict]],
        ...
        model = os.getenv("PLANNER_AGENT_GPT_VERSION",
                          os.getenv("SELECT_AGENT_GPT_VERSION", "gpt-5.4"))
    ...
    def _bfs_find_path(self, from_page: int, to_page: int,
        ...
        """BFS to find shortest path in Subtask Graph."""
    ...
    def _build_planned_path(self, edges: List[dict], final_subtask: Optional[str],
        ...
        """Convert Subtask Graph edges to planned_path format with transit detection.
