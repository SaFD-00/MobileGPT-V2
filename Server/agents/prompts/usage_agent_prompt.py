...
def get_sys_prompt():
    """시스템 프롬프트 생성"""
    sys_msg = (
        "You are a technical writer who creates concise usage descriptions for mobile app subtasks. "
...
def get_usr_prompt(subtask: dict, action_history: list):
    ...
    usr_msg = (
        ...
        "Write a concise usage description (start with a verb):\n"
    )
    return usr_msg


def get_prompts(subtask: dict, action_history: list) -> list:
    """usage_agent용 프롬프트 생성
