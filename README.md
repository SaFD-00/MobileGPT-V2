...
| **action_summarize_agent** | Module | 액션 히스토리 요약 |
| **param_fill_agent** | Module | subtask 파라미터 자동 채우기 |
| **subtask_merge_agent** | Module | 중복 subtask 병합 |
| **app_agent** | Module | 앱 패키지 정보 조회/예측 |
...
# 레거시 (미사용)
os.environ["SELECT_AGENT_HISTORY_GPT_VERSION"] = "gpt-5.2"  # 미사용
os.environ["GUIDELINE_AGENT_GPT_VERSION"] = "gpt-5.2"       # 미사용
```
...
│   ├── agents/                          # LLM 에이전트 (6 Class + 9 Module)
