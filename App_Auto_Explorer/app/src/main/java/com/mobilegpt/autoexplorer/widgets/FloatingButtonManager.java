package com.mobilegpt.autoexplorer.widgets;
...
import com.mobilegpt.autoexplorer.MobileGPTAccessibilityService;
import com.mobilegpt.autoexplorer.MobileGPTClient;
import com.mobilegpt.autoexplorer.R;
...
public class FloatingButtonManager implements View.OnClickListener {
    ...
    public FloatingButtonManager(Context context, MobileGPTClient client) {
        ...
        mFinishButton.setOnClickListener(view -> ((MobileGPTAccessibilityService) mContext).finish());
        mCaptureButton.setOnClickListener(view -> ((MobileGPTAccessibilityService) mContext).captureScreen());
        mStartButton.setOnClickListener(view -> ((MobileGPTAccessibilityService) mContext).start());
    }
